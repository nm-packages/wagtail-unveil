...
Built-in hook resolvers currently cover Wagtail form submissions, an explicit safe allowlist of single-parameter `wagtailadmin_pages` routes, and workflow usage routes.
