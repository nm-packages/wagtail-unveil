...
.PHONY: help setup env install migrate superuser sample-data runserver run test test-js build-js tox tox-smoke lint lint-fix lint-js lint-js-fix makemigrations pre-commit coverage coverage-html clean
