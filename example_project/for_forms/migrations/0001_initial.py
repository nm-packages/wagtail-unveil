    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='for_forms.exampleformpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
